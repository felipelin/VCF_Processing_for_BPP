...
All passing loci concatenated into `<outdir>/merged.phy`, with one block per locus separated by blank lines:
```
184 2502
...
7. If `--merge` is set, appends all passing loci into a single merged PHYLIP file
